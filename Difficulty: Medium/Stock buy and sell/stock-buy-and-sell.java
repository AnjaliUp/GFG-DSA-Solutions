...
class Solution {
    ...
    ArrayList<ArrayList<Integer>> stockBuySell(int A[], int n) {
        ...
        while (i < n - 1) {
            ...
            if (i == n - 1) break; // We are at the end of the array, no more transactions possible
            
            int buy = i; // Mark this as buy day
            i++;
            ...
            int sell = i - 1; // Mark this as sell day
            
            // Add the buy and sell pair to the result
